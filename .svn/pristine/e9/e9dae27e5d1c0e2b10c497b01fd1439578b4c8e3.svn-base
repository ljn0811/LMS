...
public interface LearningMaterialsDao {
	...
	/** 등록 */
	public int learningMaterialsSaveFile(Map<String, Object> paramMap) throws Exception;
	
	/** 수정 */
	public int learningMaterialsUpdateFile(Map<String, Object> paramMap) throws Exception;	
