...
public interface RegisterListControlDao {
	...
	/** 목록 조회 */
	public List<RegisterListControlVO> registerListControlPlan(Map<String, Object> paramMap);
	
	/** 유저정보 단건조회 조회 */
	public RegisterListControlVO lecUserinfo(Map<String, Object> paramMap) throws Exception;
	
	/** 목록 조회 */
	public List<RegisterListControlVO> registerListControlList(Map<String, Object> paramMap);
